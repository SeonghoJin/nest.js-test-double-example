...
describe('PostService', function () {
    ...
    beforeEach(async () => {
        ...
        postRepository = module.get<MockRepository<Post>>(
    ...
    describe('findOne()', () => {
        ...
        it('should be findOne', async () => {
            ...
            postRepository.findOne.mockRejectedValue(mockedPost);
        ...
        it('should fail if no post is found', async () => {
            ...
            expect(result).toEqual(new EntityNotFoundError(Post, findOneArgs.id));
        })
